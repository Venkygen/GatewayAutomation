...
public class PackagesPage {
	...
	public final static By nxtBtn = By.name("nextBtn");
	public final static By uploadButton = By.xpath(".//*[@id='uploadButton']/span");
	public final static By finishButton = By.name("finishBtn");
	...
	public final static By toast_Success = By.xpath(".//*[@id='toast-container']//div[text()='Success']");
