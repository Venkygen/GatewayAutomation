...
public class PolicyElementsPage {
	...
	public static By authenticationType =By.xpath(".//*[@id='policyElementAttrs']//select[@name='authenticationType']");
	public static By authProvider =By.xpath(".//*[@id='policyElementAttrs']//select[@name='authProvider']");
	...
	public static By meteringPayloadType = By.xpath(".//*[@id='policyElementAttrs']//select[@name='meteringPayloadType']");
	public static By meteringhitType =By.xpath(".//*[@id='policyElementAttrs']//select[@name='hitType']");
	public static By rateLimit = By.xpath(".//*[@id='policyElementsList']//a[@name='Rate-Limit']");
	public static By rl_frequency = By.xpath(".//*[@id='policyElementAttrs']//input[@name='frequency']");
	...
	public static By rl_target = By.xpath(".//*[@id='policyElementAttrs']//select[@name='target']");
	public static By rl_hitType = By.xpath(".//*[@id='policyElementAttrs']/div[1]//select[@name='hitType']");
	public static By rl_frequencyUnit = By.xpath(".//*[@id='policyElementAttrs']//select[@name='frequencyUnit']");
