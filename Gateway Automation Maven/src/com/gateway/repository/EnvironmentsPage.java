...
public class EnvironmentsPage {
	...
	public static By EnvSearch  =By.xpath(".//*[@id='apiEnvironmentsGridSearch']//input[@placeholder='Search']");
	public final static By EnvPolicyTemplateLink = By.linkText("Environment Policy Templates");
